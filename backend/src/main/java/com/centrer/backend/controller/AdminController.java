...
public class AdminController {
    ...
    public ResponseEntity<AppointmentAdminResponse> createAppointment(
            @Valid @RequestBody AdminAppointmentRequest request) {
        return ResponseEntity.status(201).body(adminService.createAppointmentForPatient(request));
    }
    ...
    public ResponseEntity<PatientDetailResponse> getPatientDetail(@PathVariable Long id) {
        return ResponseEntity.ok(adminService.getPatientDetail(id));
    }
