...
export function AuthProvider({ children }) {
  ...
  /**
   * Met à jour les infos de profil (nom/prénom/téléphone) sans toucher au
   * token — contrairement à saveAuth, appelée après login/register où un
   * nouveau token est toujours présent, ici les réponses de /auth/me n'en
   * renvoient pas.
   */
